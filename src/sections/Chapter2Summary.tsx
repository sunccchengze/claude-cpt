  ...
  return (
    <section ref={ref} className="py-20 px-4 bg-gradient-to-b from-[#FAF9F5] to-[#F5F0EB]">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="relative max-w-md mx-auto mb-8 pt-16 pb-12">
          {/* Output */}
          {phase >= 2 && (
            <motion.div
              className="absolute top-0 left-1/2 -translate-x-1/2 bg-[#D97757] text-white px-4 py-2 rounded-xl font-[Poppins] font-semibold text-sm shadow-sm whitespace-nowrap"
          ...
          {/* Input label */}
          <motion.div
            className="absolute bottom-0 left-1/2 -translate-x-1/2 text-xs text-[#B1ADA1] whitespace-nowrap"
            initial={{ opacity: 0 }}
