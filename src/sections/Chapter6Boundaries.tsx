  ...
  return (
    <section id="chapter-6" ref={sectionRef} className="py-20 px-4" style={{ backgroundColor: '#F5F5F5' }}>
      ...
      <div ref={envelopeRef} className="max-w-2xl mx-auto">
        ...
        >
          {!envelopeOpen ? (
            <div className="bg-amber-700 rounded-lg p-8 text-center shadow-lg relative max-w-xs mx-auto">
            ...
            <motion.div
              className="relative bg-[#FAF9F5] rounded-lg p-8 md:p-10 shadow-xl border border-[#B1ADA1]/30 max-w-2xl mx-auto text-center"
              initial={{ scale: 0.8, opacity: 0 }}
              animate={{ scale: 1, opacity: 1 }}
              transition={{ type: 'spring' }}
            >
              <div className="absolute top-3 right-3 text-xs">🤯 机密等级</div>
              
              <div className="font-mono text-sm md:text-[15px] space-y-3 text-[#141413] text-center">
                <motion.p
